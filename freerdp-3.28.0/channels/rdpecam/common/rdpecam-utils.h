                                                            ...
                                                            const char* fkt, size_t line)
{
	switch (val)
	{
		case AM_MEDIA_TYPE_DESCRIPTION_FLAG_Invalid:        /* 0x00 — no flags, sent by Windows RDP server */
		case CAM_MEDIA_TYPE_DESCRIPTION_FLAG_DecodingRequired: /* 0x01 */
		case CAM_MEDIA_TYPE_DESCRIPTION_FLAG_BottomUpImage:    /* 0x02 */
			return true;
		default:
			rdpecam_PrintWarning(log, file, fkt, line,
